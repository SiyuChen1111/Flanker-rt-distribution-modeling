...
|---|---:|---:|---:|---:|---:|---:|:---:|:---:|:---:|
| 20-29 | 3875 | 0.300 | 1.301 | 23.786 | -0.0482132 | -0.562471 | no | no | no |
| 20-29 | 5675 | 0.100 | 1.594 | 0.923 | -0.0165365 | -0.0032108 | no | no | no |
| 20-29 | 677 | 0.500 | -1.219 | 6.637 | -0.0704782 | nan | no | no | no |
| 80-89 | 3403 | 0.500 | -0.632 | 7.467 | 0.159388 | nan | yes | no | no |
| 80-89 | 6609 | 0.500 | -32.986 | 13.892 | -0.159868 | nan | no | no | no |
| 80-89 | 984 | 0.300 | -1.929 | 2.810 | -0.245767 | -0.173799 | no | no | no |
...
- `skew_present (pred_skewness > 0.5)`: 2/6
- `model_has_errors` (non-empty predicted error regime on held-out): 3/6
- `error_direction_match` (sign(model_gap) == sign(human_gap)): 3/6
- `nondegenerate_accuracy` (|model_acc - human_acc| <= 0.05): 0/6

**Most common failure modes (not mutually exclusive):**
- missing model errors on held-out: 3/6
- wrong error-vs-correct RT direction given errors: 0/6
- degenerate accuracy relative to subject: 6/6
- insufficient predicted RT skew: 4/6
