...
|---|---:|---:|---:|---:|---:|---:|:---:|:---:|:---:|
| 20-29 | 3875 | 0.300 | 1.936 | 23.786 | -0.0482132 | nan | no | no | no |
| 20-29 | 5675 | 0.100 | 1.964 | 0.923 | -0.0165365 | -0.00844544 | no | no | no |
| 20-29 | 677 | 0.500 | 0.413 | 6.637 | -0.0704782 | -0.540559 | no | no | no |
| 80-89 | 3403 | 0.500 | 0.921 | 7.467 | 0.159388 | -0.887139 | yes | no | no |
| 80-89 | 6609 | 0.500 | -3.682 | 13.892 | -0.159868 | -0.156675 | no | no | no |
| 80-89 | 984 | 0.300 | -0.218 | 2.810 | -0.245767 | -0.573637 | no | no | no |
...
- `model_has_errors` (non-empty predicted error regime on held-out): 5/6
- `error_direction_match` (sign(model_gap) == sign(human_gap)): 4/6
- `nondegenerate_accuracy` (|model_acc - human_acc| <= 0.05): 0/6

**Most common failure modes (not mutually exclusive):**
- missing model errors on held-out: 1/6
- wrong error-vs-correct RT direction given errors: 1/6
