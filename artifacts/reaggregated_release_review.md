...
`artifacts/results/repro_legacy_interim/true_single_subject_feasibility_rt_response_only/reaggregated/human_subject_level_metrics.csv` | 1559 bytes | csv | aggregated subject-level human metrics | archive_not_public | explicitly excluded from public release after final human review
...
`artifacts/results/repro_legacy_interim/true_single_subject_feasibility_rt_response_only/reaggregated/model_subject_level_metrics.csv` | 1729 bytes | csv | aggregated subject-level model metrics | archive_not_public | explicitly excluded from public release after final human review
...
`artifacts/results/repro_legacy_interim/true_single_subject_feasibility_rt_response_only/reaggregated/subject_level_comparison.csv` | 1138 bytes | csv | aggregated subject comparison | archive_not_public | explicitly excluded from public release after final human review
